...
const AdvancedSearchForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.get(`https://godown-management.onrender.com/api/v1/item/search/advanced`, {
  ...
  return (
    <div className="w-[100%] mx-auto p-4 bg-white rounded-lg shadow-md">
        <div className='flex justify-end'>
          <NavLink className="px-3 py-2 bg-violet-500 text-white font-semibold mb-3 rounded-md" to="/">
            Home
          </NavLink>
        </div>
